    ...
    <div className="app-container" style={{ minHeight: '100vh', display: 'flex' }}>
      ...
      <aside style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '48px' }}>
          ...
          <h1 style={{ fontSize: '1.25rem', color: 'var(--primary-color)' }}>EcoMonitor</h1>
        </div>
      ...
      <main style={{ marginLeft: '260px', flex: 1, padding: '32px' }}>
        <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
          <div>
            <h2 style={{ fontSize: '2rem', marginBottom: '4px' }}>Welcome back, User</h2>
            <p style={{ color: 'var(--text-secondary)' }}>Here's your energy summary for January.</p>
          </div>
